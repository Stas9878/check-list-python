...
13. [Docker для начинающих + практический опыт](https://stepik.org/course/123300/info) \
...
14. [Продвинутый Django 4 для продолжающих](https://stepik.org/course/177355/info) \
...
15. [Введение в Linux](https://stepik.org/course/73/promo) \
...
16. [Асинхронный Python](https://stepik.org/course/170777/promo) \
...
17. [WEB Парсинг на Python](https://stepik.org/course/104774/promo) \
...
18. [Быстрый старт в FastAPI Python](https://stepik.org/course/179694/promo) \
...
19. [FastAPI Пет-Проект](https://youtube.com/playlist?list=PLeLN0qH0-mCVQKZ8-W1LhxDcVlWtTALCS&si=6HUnwy1gkexDe2IW) \
...
20. [FastAPI YouTube курс](https://www.youtube.com/watch?v=z4pbneT6SLw&list=PLYnH8mpFQ4akzzS1D9IHkMuXacb-bD4Cl&index=2) \
...
21. [Многопоточный Python](https://stepik.org/course/190100/)
\
...
22. [Python for Data Science: Практика Numpy](https://stepik.org/course/189476/)
\
...
23. [Изучаем Pandas на финансовых данных](https://stepik.org/course/177903/)
\
...
24. [Видео - курс по Django REST Framework](https://www.youtube.com/playlist?list=PLA0M1Bcd0w8xZA3Kl1fYmOH_MfLpiYMRs)
\
...
25. [Рефакторинг и паттерны проектирования](https://refactoring.guru/ru)
\
